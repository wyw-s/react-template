...
interface SimpleVerifyState {
  isMouseEnter: boolean;
  diff: number;
}

export default class SimpleVerify extends React.Component<SimpleVerifyProps, SimpleVerifyState> {
  /**
   * 默认参数
   */
  static defaultProps = {
  ...
  constructor(props: SimpleVerifyProps) {
    super(props);
    this.state = {
      /** 是否滑入 */
      isMouseEnter: false,
  ...
  public render() {
    ...
    return (
      <div style={this.style} className={prefixCls}>
